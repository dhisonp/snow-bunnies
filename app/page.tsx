...
export default function Home() {
  ...
  const [editingTrip, setEditingTrip] = React.useState<TripConfig | undefined>(undefined);
        ...
        {trips.length === 0 ? (
           <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-md">
                Get started by planning your next powder adventure. We'll help you find the best weather and avoid the crowds.
              </p>
              <Button size="lg" onClick={handleCreate}>Plan First Trip</Button>
           </div>
        ) : (
