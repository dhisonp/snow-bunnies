...
export function ResortCard({ trip, resort, onEdit, onDelete }: ResortCardProps) {
  ...
  }, [resort.coordinates.lat, resort.coordinates.lon, trip.dateRange.start, trip.dateRange.end]);
    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="grid gap-4">
        ...
        <div className="border rounded-md p-3 bg-muted/20">
             ...
             <p className="text-xs text-muted-foreground">Normally 8cm snowfall this week. Current forecast is <span className="text-green-600 font-medium">above average</span>.</p>
        </div>

        <div>
            <div className="flex items-center justify-between mb-2">
                <div className="text-sm font-medium">Crowd Forecast</div>
                <div className="text-xs px-2 py-0.5 rounded-full bg-yellow-100 text-yellow-800">Moderate</div>
            </div>
            <CrowdChart data={mockCrowd} peakHours="10am - 2pm" bestArrivalTime="Before 8:30am" />
        </div>
